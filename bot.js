...
client.on('message', async msg => {
    ...
    .setTitle(':warning: | İlk olarak sesli bir kanala giriş yapmanız gerek.'));
      ...
      .setTitle(`**✅ | Oynatma Listesi: **${playlist.title}** Kuyruğa Eklendi!**`)
         ...
         .setTitle(' RTX Müzik | Müzik Seçimi')
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('9ac0cd'));
		  return msg.channel.sendEmbed(new Discord.RichEmbed()
    .setColor('9ac0cd')
     .setTitle(' RTX Müzik | Şarkı Kuyruğu')
...
function play(guild, song) {
  ...
  .setTitle("** RTX  Müzik | Müzik Başladı**",`https://cdn.discordapp.com/avatars/473974675194511361/6bb90de9efe9fb80081b185266bb94a6.png?size=2048`)
